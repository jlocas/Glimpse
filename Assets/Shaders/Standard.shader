...
////// Lighting:
                half4 lightAccumulation = tex2Dproj(_LightBuffer, UNITY_PROJ_COORD(i.projPos));
                    ...
                    half3 lightmapAccumulation = half3(0,0,0);
                        ...
                        half3 specColor = lm * tex2D(_Spec,TRANSFORM_TEX(node_25.rg, _Spec)).rgb * lmspec;
...
/////// Diffuse:
                ...
                #endif
////// Specular:
                float3 specularColor = tex2D(_Spec,TRANSFORM_TEX(node_25.rg, _Spec)).rgb;
                ...
                finalColor += diffuseLight * tex2D(_Diffuse,TRANSFORM_TEX(node_25.rg, _Diffuse)).rgb;
                finalColor += specular;
/// Final Color:
